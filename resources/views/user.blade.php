  ...
  <header class="md:flex items-center justify-between     py-3 md:py-4 bg-gray-900  relative   text-gray-50 ">
    <div class="flex justify-between min-w-min px-4">
     ...
     <nav class=" md:mt-0 transition delay-300 ease-out md:px-4">             
       <ul id="menu" class=" bg-gray-800 w-full py-4 md:py-0 md:mt-0 z-40 absolute   md:relative  md:bg-gray-900 mt-3 pl-4   flex flex-col hidden md:flex   md:flex-row m-0 p-0  text-lg md:items-center gap-8">
           <li><a href="/blog" class="hover:text-blue-400 ">Blog</a></li>
           <li><a href="/about"  class="hover:text-blue-400 ">About Us</a></li>
           <li><a href="/contact" class="text-blue-400 font-bold">Contact Us</a></li>
     ...
     <div class="container mx-auto flex h-full justify-center mt-8 relative">
         <section class="flex flex-col md:flex-row gap-4      p-4 w-full justify-center">
            <div class="bg-blue-900 rounded-2xl flex flex-col px-8 justify-center items-center md:items-start order-2 md:order-1 md:rounded-tl-2xl md:rounded-bl-2xl">
                <h1 class="text-4xl mt-8 md:mt-0 border-b-2 md:border-b-0 text-gray-50">Contact Us</h1>

                <div class="mt-8 flex flex-col w-full gap-8">
                    <div class="flex w-full gap-1 items-center text-xl md:text-sm  text-gray-100">
                    ...
                    <div class="flex gap-1 items-center text-xl md:text-sm text-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="flex gap-8  mt-8 mb-8 md:mb-0 items-start">
                  ...
                  class="h-12 cursor-pointer w-12 "
                >
                  <defs>
                    <radialGradient
                      fy="578.088"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 cursor-pointer pt-2" viewBox="-44.7006 -60.54775 387.4052 363.2865"><path fill="#ffffff" d="M93.719 242.19c112.46 0 173.96-93.168 173.96-173.96 0-2.646-.054-5.28-.173-7.903a124.338 124.338 0 0030.498-31.66c-10.955 4.87-22.744 8.148-35.11 9.626 12.622-7.57 22.313-19.543 26.885-33.817a122.62 122.62 0 01-38.824 14.841C239.798 7.433 223.915 0 206.326 0c-33.764 0-61.144 27.381-61.144 61.132 0 4.798.537 9.465 1.586 13.941-50.815-2.557-95.874-26.886-126.03-63.88a60.977 60.977 0 00-8.279 30.73c0 21.212 10.794 39.938 27.208 50.893a60.685 60.685 0 01-27.69-7.647c-.009.257-.009.507-.009.781 0 29.61 21.075 54.332 49.051 59.934a61.218 61.218 0 01-16.122 2.152 60.84 60.84 0 01-11.491-1.103c7.784 24.293 30.355 41.971 57.115 42.465-20.926 16.402-47.287 26.171-75.937 26.171-4.929 0-9.798-.28-14.584-.846 27.059 17.344 59.189 27.464 93.722 27.464"/></svg>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 cursor-pointer pt-2 text-gray-50 fill-current" viewBox="-11.493675 -16.3118 99.61185 97.8708"><path d="M72.865 61.1094a1.2 1.2 0 001.21-1.269c0-.9-.543-1.33-1.657-1.33h-1.8v4.712h.677v-2.054h.832l.019.025 1.291 2.029h.724l-1.389-2.1zm-.783-.472h-.785v-1.593h.995c.514 0 1.1.084 1.1.757 0 .774-.593.836-1.314.836m-16.873-5.433h-9.6v-15.034c0-3.585-.064-8.2-4.993-8.2-5 0-5.765 3.906-5.765 7.939v15.294h-9.6v-30.916h9.216v4.225h.129a10.1 10.1 0 019.093-4.994c9.73 0 11.524 6.4 11.524 14.726zm-40.79-35.143a5.571 5.571 0 115.57-5.572 5.571 5.571 0 01-5.57 5.572m4.8 35.143h-9.61v-30.917h9.61zm40.776-55.2H4.781A4.728 4.728 0 000 4.6744v55.439a4.731 4.731 0 004.781 4.675h55.21a4.741 4.741 0 004.8-4.675V4.6704a4.738 4.738 0 00-4.8-4.67"/><path d="M72.164 56.4114a4.418 4.418 0 10.085 0h-.085m0 8.33a3.874 3.874 0 113.809-3.938v.065a3.791 3.791 0 01-3.708 3.871h-.1"/></svg>


                </div>
            </div>
            <div class="md:w-1/2 order-1">
              <h2 class="text-4xl font-bold mb-4 tracking-wider text-blue-600">Get In Touch</h2>
                <form class="w-full">
                    <div class="w-full">
                        <label class="text-gray-600 font-medium md:my-2">Your Message</label>
                        <textarea placeholder="your message" cols="5" rows="6" class="outline-none focus:outline-none border   text-xl   p-4 text-gray-800  w-full"></textarea>

                    </div>
                    <div class="w-full">
                        <label class="text-gray-600 font-medium md:my-2">Your Email</label>
                        <input type="email" class="w-full  p-2 my-2 px-4 border focus:border-b-4  text-xl text-gray-800  focus:outline-none" placeholder="your email" required="true " />

                    </div>
                    <div class="w-full mb-4 md:mb-0">
                        <label class="text-gray-600 font-medium md:my-2">Your Name</label>
                        <input type="text" class="w-full  p-2 px-4 border  text-xl text-gray-800  focus:outline-none" placeholder="your name" required="true " />


                    </div>
                    <button class="my-2 py-3 delay-200 text-md uppercase  tracking-wider font-medium text-center w-full rounded-full bg-blue-700 text-gray-50 hover:text-blue-900 hover:bg-transparent border hover:border-blue-900  focus:outline-none " type="submit">Send</button>
